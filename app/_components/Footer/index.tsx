...
export default function Footer() {
  return (
    <MediaQuerySelecter
      sm={
        <footer className="bg-[#232127] flex flex-col items-center text-white py-12 gap-3">
          <Logo />
          <ul className="text-center flex flex-col">
            <li className="py-4">
              <span className="font-bold">Features</span>
              <ul className="mt-4">
                <li className="active:text-[#2acfcf] cursor-pointer">
                  Link Shortening
                </li>
                <li className="active:text-[#2acfcf] cursor-pointer">
                  Branded Links
            ...
            <li className="py-4">
              ...
              <ul className="mt-4">
                <li className="active:text-[#2acfcf]  cursor-pointer">Blog</li>
                <li className="active:text-[#2acfcf]  cursor-pointer">
                  Developers
                </li>
                <li className="active:text-[#2acfcf]  cursor-pointer">
            ...
            <li className="py-4">
              ...
              <ul className="mt-4">
                <li className="active:text-[#2acfcf] cursor-pointer">About</li>
                <li className="active:text-[#2acfcf] cursor-pointer">
                  Our Team
                </li>
                <li className="active:text-[#2acfcf] cursor-pointer">
          ...
          <ul className="flex gap-6">
            <li>
              <a
                ...
                className="active:text-[#2acfcf] text-white cursor-pointer"
              >
                <FacebookLogo />
              </a>
            </li>
...
const Desktop = () => {
  return (
    <footer className="bg-[#232127] px-2 flex-col flex items-center">
      <div className="flex justify-between w-full text-white py-12 gap-3 max-w-6xl">
        <div>
          <Logo />
        </div>
